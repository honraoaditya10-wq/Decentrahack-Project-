...
class _DonateBooksScreenState extends State<DonateBooksScreen> {
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _buildDetailRow("📚", "Book", bookName),
                _buildDetailRow("📦", "Category", selectedCategory),
                _buildDetailRow("🔢", "Quantity", "${_quantityController.text} books"),
                const SizedBox(height: 8),
  ...
  void _resetForm() {
    setState(() {
      bookName = "";
      selectedCategory = "Novels and Stories";
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _categoryButton("Novels and Stories", Icons.auto_stories),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: _categoryButton("Textbooks", Icons.school),
              ),
            ],
          ),
          ...
          Row(
            children: [
              Expanded(
                child: _categoryButton("Children's Books", Icons.child_care),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: _categoryButton("Reference Books", Icons.library_books),
              ),
            ],
          ),
          const SizedBox(height: 10),
