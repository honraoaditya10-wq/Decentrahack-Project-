...
class _DonateFoodScreenState extends State<DonateFoodScreen> {
    ...
    try {
      ...
      await _firestore.runTransaction((transaction) async {
        ...
        if (!snapshot.exists) {
          ...
          int currentFood = data['foodDonations'] ?? 0;
          
          transaction.update(userDoc, {
            'totalDonations': currentTotal + 1,
            'foodDonations': currentFood + 1,
            'lastDonationAt': FieldValue.serverTimestamp(),
            'lastLoginAt': FieldValue.serverTimestamp(),
          });
        }
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _buildDetailRow("🍽", "Food", foodName),
                _buildDetailRow("📦", "Category", selectedCategory),
                _buildDetailRow("⚖", "Quantity", selectedQuantity),
                if (expiryDate != null)
                  _buildDetailRow("📅", "Expiry", "${expiryDate!.day}/${expiryDate!.month}/${expiryDate!.year}"),
                const SizedBox(height: 8),
          ...
          actions: [
            TextButton(
              ...
              child: const Text("OK", style: TextStyle(color: textColor, fontWeight: FontWeight.bold)),
            ),
          ],
        );
      },
  ...
  // Helper Widgets (keeping existing ones and adding improvements)
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            "Help feed those in need by donating your excess food",
  ...
  // Keep existing helper widgets with minor improvements...
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _categoryButton("Cooked Food", Icons.restaurant_menu),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: _categoryButton("Raw Food", Icons.eco),
              ),
            ],
          ),
          ...
          Row(
            children: [
              Expanded(
                child: _categoryButton("Packaged Food", Icons.inventory_2),
              ),
              const SizedBox(width: 10),
              Expanded(
  ...
  Widget inputField({
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          hintText: hint,
          prefixIcon: const Icon(Icons.fastfood, color: Color(0xFF5C2C9C)),
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: const BorderSide(color: Color(0xFFB17CDF)),
          ),
  ...
  Widget dropdownField({
    ...
    return Padding(
      ...
      child: DropdownButtonFormField<String>(
        ...
        decoration: InputDecoration(
          hintText: hint,
          prefixIcon: const Icon(Icons.scale, color: Color(0xFF5C2C9C)),
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: const BorderSide(color: Color(0xFFB17CDF)),
          ),
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              const Icon(Icons.calendar_today, color: Color(0xFF5C2C9C)),
              const SizedBox(width: 12),
              Text(
                date != null 
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              const Icon(Icons.access_time, color: Color(0xFF5C2C9C)),
              const SizedBox(width: 12),
              Expanded(
                child: Text(
                  displayText,
...
// optional widgets after the Text
if (_centerLocation != null) ...[
  const SizedBox(height: 4),
  Text(
